...
def detect(save_img=False):
    ...
    if webcam:
        ...
        save_img = True
        # 如果检测图片的时候想显示出来，可以在这里加一行view_img = True
        # view_img = True
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train/SHWD/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default=r'D:\DeepLearning\ZData\SHWD\yolov5FormatTrainData\images\test', help='source')  # file/folder, 0 for webcam
    ...
    parser.add_argument('--name', default='SHWD', help='save results to project/name')
